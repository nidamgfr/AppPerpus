    ...
    bSimpan.addActionListener (new ActionListener(){
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (status==SEDANG_TAMBAH) {
                        ...
                        // insert into penerbit (penerbit) values ( ? , ? , ? )
                        // contoh kalau datanya banyak
                        ps = con.prepareStatement(executeQuery);
                        ps.setString(1, ePenerbit.getText());
                        // klu misalnya bnyak data , ditulis aja . ini kan karena kolom nya memang cuman ada dua , yang id itu otomatis .
                    } else {
